...
custom_irules = [
        ...
        { from_port = "8189", to_port="8189", protocol="tcp",self_sg=true, name = "prep" , direction="Inbound" , access="Allow", source_address_prefix="*"},
        { from_port = "8191", to_port="8191", protocol="tcp",self_sg=true, name = "pqwe" , direction="Inbound" , access="Allow", source_address_prefix="*"},
        { from_port = "9997", to_port="9997", protocol="tcp",cidr_block="", name = "ofwd2" , direction="Outbound" , access="Allow", source_address_prefix="*"},
        { from_port = "8089", to_port="8089", protocol="tcp",self_sg=true, name = "ofwd" , direction="Outbound", access="Allow", source_address_prefix="*"},
]
